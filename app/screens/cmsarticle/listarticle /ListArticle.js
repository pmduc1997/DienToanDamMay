...
class ListArticle extends BaseScreen {
  constructor(props) {
    super(props)
    this.state = {
      data: [
      ...
      >
        <View style={styles.item}>
          <View style={styles.textName}>
            ...
            <Text style={styles.desuser}>{item.content} </Text>
          </View>
  ...
  componentDidMount() {
    ...
    axios.get(`http://108.160.133.232:3040/v1/articles`, { headers: { Authorization: AuthStr } })
      .then(res => {
        const data = res.data;
      ...
      <View style={styles.container}>
        ...
        <View style={styles.more}>
          ...
          <TouchableOpacity style={styles.more2} onPress={this._doAddUser}>
            <Text style={styles.btnAddUser}>Thêm bài viết </Text>
          </TouchableOpacity>
        </View>
      </View>
    );
